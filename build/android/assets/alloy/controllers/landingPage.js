function Controller() {
    ...
    $.menuContainer.children[0].addEventListener("click", function() {
        nextWindow("prescriptionOne");
    });
    $.menuContainer.children[1].addEventListener("click", function() {
        nextWindow("doctorOne");
    });
    $.menuContainer.children[2].addEventListener("click", function() {
        nextWindow("storeOne");
    });
    $.menuContainer.children[3].addEventListener("click", function() {
